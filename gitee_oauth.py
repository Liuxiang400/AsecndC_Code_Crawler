...
class GiteeOAuth:
    ...
    DEFAULT_SCOPES = ["user_info", "projects", "pull_requests", "issues", "notes"]
    ...
    def save_to_file(self, filepath: str = ".gitee_token.json"):
        """
        保存令牌到文件
    ...
    def load_from_file(self, filepath: str = ".gitee_token.json") -> bool:
        """
        从文件加载令牌
